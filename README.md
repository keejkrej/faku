...
Keys: Cmd/Ctrl-N is sidebar New Task, Cmd/Ctrl-K focuses sidebar search, Cmd/Ctrl-, opens settings, Cmd/Ctrl-[ and Cmd/Ctrl-] walk sidebar session history, Cmd/Ctrl-B toggles the sidebar rail, Enter send/queue, Esc cancel. Cmd/Ctrl-Enter
