...
Keys: Cmd/Ctrl-N is sidebar New Task, Cmd/Ctrl-K focuses sidebar search, Cmd/Ctrl-, opens settings, Cmd/Ctrl-[ and Cmd/Ctrl-] walk sidebar session history, Enter send/queue, Esc cancel. Cmd/Ctrl-Enter
