...
const reveal_folder_key = sidecar_keys.reveal_folder_key;
const open_terminal_key = sidecar_keys.open_terminal_key;
...
pub fn handleFxLine(model: *Model, fx: *Effects, line: native_sdk.EffectLine) void {
    ...
    if (model.daemon_set_skills_enabled_key != 0 and line.key == model.daemon_set_skills_enabled_key) {
    ...
    if (model.daemon_restore_ref_key != 0 and line.key == model.daemon_restore_ref_key) {
...
pub fn handleFxExit(model: *Model, fx: *Effects, exit: native_sdk.EffectExit) void {
    ...
    if (model.daemon_set_skills_enabled_key != 0 and exit.key == model.daemon_set_skills_enabled_key) {
