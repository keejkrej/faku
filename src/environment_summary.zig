...
//! on Branch, Uncommitted and Staged are switchable on the card),
...
//! on Branch). Not full Review hunks, not Unstaged/Committed/
//! LastTurn, not untracked-in-Uncommitted, not force,
...
/// @{upstream}...HEAD`). Uncommitted and Staged are selected on
/// the card.
