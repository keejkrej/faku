...
statuses follow `i18n.BranchOpStatusChrome`; commit attach-status leftovers stay English this cut), and reuses the existing `git worktree add` spawn /
