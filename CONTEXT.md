...
`i18n.Sidebar.collapse_all_folders` as the sidebar button). Other
palette commands and composer Ask / Full access stay English.
...
- Full-app i18n catalogs / rust_i18n-style YAML, Native locale /
  ...
  as the sidebar button). Other palette command labels and
  composer Ask / Full access stay English. UTC-day bucketing is
