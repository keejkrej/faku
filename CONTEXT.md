...
no-match). Select a skill placeholder follows the resolved locale
...
- First-cut daemon `LoadSkills` / `SkillsCatalog` ships as a
  ...
  **permanent** directory remove of that skill dir (not OS Trash /
  ...
  selection / empty / unresolved path stays silent). Remaining Skills
  leftovers: section headers, richer empty title/description.
  In-flight
