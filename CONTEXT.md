...
zh-CN 技能库 / 技能详情 / ja スキルライブラリ / スキルの詳細; muted/bold Native
text above the stacked library block and above the detail block;
distinct from `i18n.SkillsSectionChrome` User / `i18n.SkillsSelectChrome`
