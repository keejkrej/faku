...
`PaletteAction` / keywords stay English). Expand / Collapse
...
- Full-app i18n catalogs / rust_i18n-style YAML, Native locale /
  ...
  `i18n.Palette`; ids / keywords stay English). Expand / Collapse
  sidebar a11y labels follow the resolved locale this cut (same
  `i18n.Palette` strings; distinct from the palette Toggle sidebar
