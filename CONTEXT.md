...
(Waku `aria-label`); this cut ships first-cut side-by-side (264 library |
grow details) with per-pane scroll + 1px library divider, still not resizable `<split>`, still not Waku GPUI virtualized list quirks / sticky / edge fades; distinct from
