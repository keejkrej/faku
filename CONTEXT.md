...
`scannedFiles` are present (unit labels follow the resolved locale this cut; ` · ` separators and Latin `{d:.1}s` stay). First-cut LiteLLM rate-table fetch ships
