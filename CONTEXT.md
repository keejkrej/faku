...
all folders icon button, Delete folder trash button), and folder
context-menu Rename / Delete (plain Delete, not Delete folder), and
session context-menu Rename / Remove (plus trash a11y Remove session).
Session Rename reuses the folder Rename string (EN "Rename" / zh
...
folder` (data, not chrome). Expand / Collapse folder a11y labels, palette
command "Collapse all folders", and composer Ask / Full access stay
English. UTC-day bucketing is unchanged. Not full-app catalogs, not
Native NSLocale, not tz-aware or east-asian calendar formatting.
...
- Full-app i18n catalogs / rust_i18n-style YAML, Native locale /
  ...
  session Remove). Catalog folder titles stay English `New folder`
  (data, not chrome). Expand / Collapse folder a11y labels, palette
  command labels, and composer Ask / Full access stay English.
