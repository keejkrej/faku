...
(selecting another skill or leaving Skills clears arming). First-cut
miss uses English window_status `Could not delete skill.` Enable / Disable chip and Disabled badge follow the resolved
