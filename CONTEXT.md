...
open / No background work / No output / Browse the web / Cmd/Ctrl-L
...
project path). Remaining leftovers stay English this cut (Files
empty secondary Open a project to browse its files / Loading
files…, file-preview toolbar, Filter skills / Filter projects,
Environment menu). Expand / Collapse
...
- Full-app i18n catalogs / rust_i18n-style YAML, Native locale /
  ...
  (Filter files / No project open / No background work / No output /
