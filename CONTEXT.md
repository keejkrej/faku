...
EN Diff tab reads Review). Right-panel Diff filter placeholder and
Files/Background empty-state chrome (Filter files / No project open
/ No background work / No output) follow the resolved locale this
cut (same `i18n.RightPanelChrome` strings; wire ids / on-press /
filter text stay English). Expand / Collapse
...
- Full-app i18n catalogs / rust_i18n-style YAML, Native locale /
  ...
  Diff filter placeholder and Files/Background empty-state chrome
  (Filter files / No project open / No background work / No output)
  follow the resolved locale this cut (same `i18n.RightPanelChrome`
  strings; wire ids / on-press / filter text stay English). Expand / Collapse
  sidebar a11y labels follow the resolved locale this cut (same
  `i18n.Palette` strings; distinct from the palette Toggle sidebar
