...
label, and empty-state No project usage follow the resolved locale
...
on-input stay English). Remaining leftovers stay English this cut
(Environment dropdown Background section header, No matching
projects empty).
Expand / Collapse
