...
Native math flag this cut). Files preview
...
Automatic updates stays out (Faku has no UpdaterState / in-app
updater yet). KaTeX / Native math rendering stays Native-blocked.
...
- Waku GPUI user-message edge fades and Native element `max-height`
  ...
  Render math toggle ships preference + UI only)
