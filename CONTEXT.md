...
project path). Review Diff header title / Cancel and source chips
(Branch / Uncommitted / Staged / Unstaged / Committed / Last
turn) follow the resolved locale this cut (same
`i18n.ReviewDiffChrome` strings; wire ids / on-press stay English).
...
(Review Diff gap expand Start/End/Both/All,
