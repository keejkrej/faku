...
keywords stay English). Right-panel tab names (Files / Diff /
Browser / Terminal / Background) stay English this cut. Expand / Collapse
...
- Full-app i18n catalogs / rust_i18n-style YAML, Native locale /
  ...
  strings; ids / keywords stay English). Right-panel tab names
  (Files / Diff / Browser / Terminal / Background) stay English
  this cut. Expand / Collapse
  sidebar a11y labels follow the resolved locale this cut (same
  `i18n.Palette` strings; distinct from the palette Toggle sidebar
