...
worktree… (same `i18n.WorktreeStatusChrome`; other git
attach-status leftovers stay English this cut), and reuses the existing `git worktree add` spawn /
