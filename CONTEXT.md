...
folder` (data, not chrome). Palette command "Collapse all folders" and
composer Ask / Full access stay English. UTC-day bucketing is unchanged.
...
- Full-app i18n catalogs / rust_i18n-style YAML, Native locale /
  ...
  chrome). Palette command labels and composer Ask / Full access
  stay English. UTC-day bucketing is unchanged. Not full-app
  catalogs, not Native NSLocale, not east-asian calendar formatting)
