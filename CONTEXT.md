...
stay `ask` / `auto` / `fullAccess`). Other palette commands, effort
chips, and Build/Plan stay English.
...
- Full-app i18n catalogs / rust_i18n-style YAML, Native locale /
  ...
  strings; wire ids stay `ask` / `auto` / `fullAccess`). Other palette
  command labels, effort chips, and Build/Plan stay English. UTC-day
  bucketing is
